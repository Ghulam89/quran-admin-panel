...
const AdminLogin = () => {
  ...
  return (
    <div className=" bg-LoginBg  bg-no-repeat  bg-cover bg-white h-screen flex justify-center items-center">
      <div className="bg-white  bg-opacity-85 w-full h-full flex justify-center items-center">
        ...
        >
          ...
          <div className="">
            <label className=" text-gray-400 font-semibold  py-3">
              Username
            </label>
            <input
              type="email"
              name="email"
              className="w-full   border    bg-white mt-2 p-4  rounded-lg outline-none text-black"
          ...
          <div className="">
            ...
            <input
              type="password"
              name="password"
              className="w-full mt-2    border  bg-white rounded-lg  p-4  outline-none text-black"
          ...
          <div className="mb-4    mt-2 w-full">
            {loading === true ? (
              <button
                disabled
                type="button"
                class="  bg-primary  w-full text-center p-4 rounded-lg text-white uppercase font-semibold cursor-pointer"
              >
                <svg
                  aria-hidden="true"
                  role="status"
