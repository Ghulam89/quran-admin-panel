...
import StudentSidebar from "../components/sidebar/StudentSlidebar";
import StudentNav from "../components/adminNav/StudentNav";
const StudentWrapper = ({ children }) => {
  ...
  return (
    <>
      <StudentSidebar side={side} closeSidebar={closeSidebar} />
      <StudentNav
